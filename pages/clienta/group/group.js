  ...
  inputOn(event){
    ...
    wx.getSystemInfo({
      success: function (res) {
        let scrollRpx = ((event.detail.height * (750 / res.windowWidth))+317);
    ...
    console.log('inputBottom', that.data.inputBottom)
    console.log('scrollBottom', that.data.scrollBottom)
  },
  //input焦点失去
  inputOut(){
    var that = this
